  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Danh sách giảng viên</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-sm-12">
            <div class="card-box table-responsive">
              <div class="row justify-content-between mb-2 mr-2 ml-2">
                <a href="${pageContext.request.contextPath}/instructor?action=create" class="btn btn-sm btn-outline-primary my-2 my-sm-0"><i class="fas fa-plus"></i> Thêm mới</a>
                <form class="form-inline my-2 my-lg-0" method="post" action="${pageContext.request.contextPath}/instructor?action=search">
              ...
              <table id="myTable" class="table table-colored-bordered table-bordered table-bordered-teal dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <tbody>
                <c:forEach var="instructor" items="${requestScope['list']}">
                  ...
                  <tr class="text-center" >
                    ...
                    <td>${instructor.getMail()}</td>
                    <td>${instructor.getAddress()}</td>
                    <td>${instructor.getPhoneNum()}</td>

                    <td>
                      <a href="${pageContext.request.contextPath}/instructor?action=edit&id=${instructor.getId()}"
                         title="Edit" class="btn-me" id="btn-edit">
                        <i class="fa fa-edit"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/instructor?action=delete&id=${instructor.getId()}" title="Delete"
                         class="btn-me delete" id="btn-trash">
                        <i class="fa fa-trash"></i>
                      </a>
                      <a href="${pageContext.request.contextPath}/instructor?action=info&id=${instructor.getId()}"
